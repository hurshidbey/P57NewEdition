...
const premiumPrompts = [
  {
    title: "Premium: Nuqtai Nazar Piramidasi",
    ...
    description: "Bitta mavzuni 5 xil nuqtai nazardan ko'rib, yangi tushunchalar yaratish texnikasi. Faqat premium foydalanuvchilar uchun.",
    category: "Strategik Kontent",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Muammo-Yechim Ko'prigi",
    ...
    description: "Yangi muammolarni topib, turli auditoriyalar uchun yechimlar yaratish. Faqat premium foydalanuvchilar uchun.",
    category: "Strategik Kontent",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Metafora Generatori",
    ...
    description: "Murakkab tushunchalarni oddiy metaforalar orqali tushuntirish san'ati. Faqat premium foydalanuvchilar uchun.",
    category: "Strategik Kontent",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Zaiflik Ilmoqi",
    ...
    description: "Muvaffaqiyatsizliklardan hikoya yaratib, ishonch qozonish texnikasi. Faqat premium foydalanuvchilar uchun.",
    category: "Hikoya va Voqealar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Vaqt Mashinasi Seriyasi",
    ...
    description: "O'tmishdagi tajribalardan kelajak uchun qimmatli saboqlar olish. Faqat premium foydalanuvchilar uchun.",
    category: "Hikoya va Voqealar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Hujjatli Film Ramkasi",
    ...
    description: "Kontentni hujjatli film dramaturrgiyasi asosida qurish. Faqat premium foydalanuvchilar uchun.",
    category: "Hikoya va Voqealar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Cheklov Yaratuvchisi",
    ...
    description: "Sun'iy cheklovlar orqali ijodkorlikni oshirish texnikasi. Faqat premium foydalanuvchilar uchun.",
    category: "Ijodiy G'oyalar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Aralashma Usuli",
    ...
    description: "Ikki bog'liq bo'lmagan sohani birlashtirib yangi g'oyalar yaratish. Faqat premium foydalanuvchilar uchun.",
    category: "Ijodiy G'oyalar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Anti-Maslahat Generatori",
    ...
    description: "Teskari yondashув orqali to'g'ri yo'lni o'rgatish. Faqat premium foydalanuvchilar uchun.",
    category: "Ijodiy G'oyalar",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Maxfiy Jamiyat",
    ...
    description: "Eksklyuzivlik hissi orqali auditoriyani jalb qilish. Faqat premium foydalanuvchilar uchun.",
    category: "Auditoriya Jalb Qilish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Bahs Boshlovchisi",
    ...
    description: "Fikr-mulohazalarni qo'zg'atuvchi munozarali kontent yaratish. Faqat premium foydalanuvchilar uchun.",
    category: "Auditoriya Jalb Qilish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: O'z Sarguzashtingizni Tanla",
    ...
    description: "Shaxsiylashtirilgan kontent tajribasi yaratish. Faqat premium foydalanuvchilar uchun.",
    category: "Auditoriya Jalb Qilish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Vaqt Sayohatchisining Hisoboti",
    ...
    description: "Kelajak perspektivasidan hozirgi trendlarni tahlil qilish. Faqat premium foydalanuvchilar uchun.",
    category: "Innovatsiya va Tushuncha",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Aysberg Tahlili",
    ...
    description: "Yuzaki mavzularning chuqur qatlamlarini ochib berish. Faqat premium foydalanuvchilar uchun.",
    category: "Innovatsiya va Tushuncha",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Kesishma Changlatish Generatori",
    ...
    description: "Boshqa sohalardan innovatsion yechimlarni ko'chirish. Faqat premium foydalanuvchilar uchun.",
    category: "Innovatsiya va Tushuncha",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Bashorat Portfeli",
    ...
    description: "Aniq bashoratlar orqali ekspertlik va ishonch qurish. Faqat premium foydalanuvchilar uchun.",
    category: "Obro' Qurish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Afsona Buzuvchisi",
    ...
    description: "Noto'g'ri e'tiqodlarni buzib, haqiqatni ochib berish. Faqat premium foydalanuvchilar uchun.",
    category: "Obro' Qurish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Sahna Ortidagi Fosh Qilish",
    ...
    description: "Jarayonning haqiqiy, tartibsiz tomonlarini ko'rsatish orqali ishonch qozonish. Faqat premium foydalanuvchilar uchun.",
    category: "Obro' Qurish",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Ramka Fabrikasi",
    ...
    description: "Muammolarni hal qilish uchun o'z ramkangizni yaratish. Faqat premium foydalanuvchilar uchun.",
    category: "Tizimli Fikrlash",
    is_premium: true,
    is_public: true
  },
  {
    title: "Premium: Resurs Arxeologiyasi",
    ...
    description: "Eski lekin qimmatli g'oyalarni qayta kashf etish va yangilash. Faqat premium foydalanuvchilar uchun.",
    category: "Tizimli Fikrlash",
    is_premium: true,
    is_public: true
  }
...
async function addPremiumPrompts() {
  try {
    console.log('🚀 Adding premium prompts to Supabase...');
    ...
    console.log(`\n🎉 Premium prompts have been added to Supabase!`);
