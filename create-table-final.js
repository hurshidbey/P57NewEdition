...
const connectionString = 'postgresql://postgres:20031000a@db.bazptglwzqstppwlvmvb.supabase.co:5432/postgres';
...
async function createTable() {
  try {
    ...
    console.log('✅ Select successful:', selectResult.rows.length, 'rows found');

    console.log('\n🎉 user_progress table is ready!');
