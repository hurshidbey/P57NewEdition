...
export function CodeExample({ title, badExample, goodExample, explanation }: CodeExampleProps) {
  ...
  return (
    <div className="border-2 border-black kb-example shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="my-4 px-4 py-2 h-10 border-2 border-black font-black uppercase bg-white hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
        >
