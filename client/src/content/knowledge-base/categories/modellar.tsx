     ...
     <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
       <Card className="border-2 border-black hover:shadow-lg transition-shadow">
        ...
        <CardContent className="p-4">
         <div className="space-y-2 text-sm">
          <p><strong>Narx:</strong> $0.5/1M token</p>
          <p><strong>Tezlik:</strong> Juda tez</p>
          <p><strong>Kontekst:</strong> 16K</p>
          <p><strong>Foydalanish:</strong> Chatbot, tarjima</p>
         </div>
        </CardContent>
       </Card>
       ...
       <Card className="border-2 border-black hover:shadow-lg transition-shadow">
        ...
        <CardContent className="p-4">
         <div className="space-y-2 text-sm">
          <p><strong>Narx:</strong> $30/1M token</p>
          <p><strong>Tezlik:</strong> O'rtacha</p>
          <p><strong>Kontekst:</strong> 32K</p>
          <p><strong>Foydalanish:</strong> Murakkab tahlil</p>
         </div>
        </CardContent>
       </Card>
       ...
       <Card className="border-2 border-black hover:shadow-lg transition-shadow">
        ...
        <CardContent className="p-4">
         <div className="space-y-2 text-sm">
          <p><strong>Narx:</strong> $5/1M token</p>
          <p><strong>Tezlik:</strong> Tez</p>
          <p><strong>Kontekst:</strong> 128K</p>
          <p><strong>Foydalanish:</strong> Universal</p>
         </div>
        </CardContent>
       </Card>
      </div>
     ...
     <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
       <ExpandableCard
        ...
        examples={[
         "Zararli kontentni rad etish",
         "Xolis va adolatli javoblar",
         "Shaxsiy ma'lumotlarni himoya",
         "Etik chegaralarni saqlash"
        ]}
       />
       ...
       <ExpandableCard
        ...
        examples={[
         "To'liq dasturlar yaratish",
         "Interaktiv HTML sahifalar",
         "SVG grafikalar",
         "Markdown hujjatlar"
        ]}
       />
  ...
  if gpu_memory < 8: # GB
    ...
    return "mixtral-8x22b" # Server GPU`}
      ...
      <ExpandableCard
       ...
       examples={[
        "FP16 → INT8: 2x kichik, 5% sifat yo'qotish",
        "GPTQ: 4-bit quantization",
        "GGUF: CPU-optimized format",
