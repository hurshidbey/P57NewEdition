...
<div className="space-y-6">
          ...
          <Card className="border-2 border-black">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-0">TEMPERATURE SHKALASI</h3>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">PAST (0.0-0.5)</h4>
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">O'RTA (0.5-1.0)</h4>
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">YUQORI (1.0-2.0)</h4>
...
<div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-0">TOP-P (Nucleus Sampling)</h3>
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-0">TOP-K</h3>
                <p className="text-sm text-muted-foreground mb-4">
...
<div className="space-y-6">
          ...
          <Card className="border-2 border-black">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-0">TOKEN HISOBI</h3>
          ...
          <div className="grid gap-4">
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">QISQA JAVOBLAR (50-150 token)</h4>
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">O'RTA JAVOBLAR (500-1000 token)</h4>
                <ul className="text-sm space-y-1">
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-4">
                <h4 className="font-bold mb-0">UZUN JAVOBLAR (2000+ token)</h4>
                <ul className="text-sm space-y-1">
      ...
      content: {
        render: () => (
          <div className="space-y-6">
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-0">QACHON ISHLATILADI:</h3>
                <div className="space-y-4">
...
# To'xtaydi!`}
            ...
            <Card className="border-2 border-black bg-gray-50">
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-0">AMALIY MISOLLAR:</h3>
        ...
        render: () => (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="border-2 border-black">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-0">PRESENCE PENALTY</h3>
              ...
              <Card className="border-2 border-black">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-0">FREQUENCY PENALTY</h3>
...
kerak. Mijozlar ehtiyojini tahlil qilib..."  # Rang-barang!`}
            ...
            <Card className="border-2 border-black">
              <CardContent className="p-6">
                <h3 className="text-lg font-bold mb-0">QO'LLANISH SOHALARI:</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <Badge className="mb-2">Texnik hujjatlar</Badge>
                    <p className="text-sm">Presence: 0.0-0.3<br/>Frequency: 0.3-0.5</p>
                  </div>
                  <div>
                    <Badge className="mb-2">Dialog tizimlar</Badge>
                    <p className="text-sm">Presence: 0.4-0.8<br/>Frequency: 0.4-0.8</p>
                  </div>
                  <div>
                    <Badge className="mb-2">Kod generatsiya</Badge>
