...
agent: 
 ...
 4. [Dinamik, yangilangan natijalar]`}
      ...
      <ExpandableCard
       ...
       examples={["ReAct Agent - Fikrlash va harakat qilish sikli","Task Agent - Aniq vazifalarni bajarish","Conversational Agent - Suhbat orqali yordam","Autonomous Agent - To'liq mustaqil ishlash"
       ]}
      />
      ...
      <div className="grid gap-4 md:grid-cols-2">
       <Card className="border-2 border-black">
        <CardContent className="p-4">
         <h4 className="font-bold text-black ">AFZALLIKLAR</h4>
       ...
       <Card className="border-2 border-black">
        <CardContent className="p-4">
         <h4 className="font-bold text-black ">CHEKLOVLAR</h4>
         <ul className="text-sm">
          <li>- API limitlari</li>
   ...
   content: {
    render: () => (
     <div>
      ...
      <Card className="border-2 border-black bg-gray-50">
       <CardContent className="p-6">
        <h3 className="text-xl font-bold text-center ">ORCHESTRATION ARXITEKTURASI</h3>
        
        <div>
         {/* Orchestrator */}
         <div className="border-3 border-black bg-white p-4 shadow-lg">
          <h4 className="font-bold text-center ">ORCHESTRATOR</h4>
         ...
         <div className="grid grid-cols-3 gap-4">
          <div className="border-2 border-gray-600 bg-gray-50 p-3">
           <h5 className="font-bold text-sm text-center">Tahlil Agent</h5>
           <p className="text-xs text-center ">Ma'lumotlarni tahlil qilish</p>
          </div>
          <div className="border-2 border-gray-600 bg-gray-50 p-3">
           <h5 className="font-bold text-sm text-center">Yozuv Agent</h5>
           <p className="text-xs text-center ">Kontent yaratish</p>
          </div>
          <div className="border-2 border-gray-600 bg-gray-50 p-3">
           <h5 className="font-bold text-sm text-center">Tekshiruv Agent</h5>
         ...
         <div className="border-2 border-gray-600 bg-gray-100 p-4">
          <h4 className="font-bold text-center ">UMUMIY RESURSLAR</h4>
      ...
      <ExpandableCard
       ...
       examples={["Sequential - Ketma-ket bajarish","Parallel - Parallel ishlash","Hierarchical - Ierarxik tuzilma","Collaborative - Hamkorlikda ishlash","Competitive - Raqobat asosida"
       ]}
      />
...
agent.execute("1. Ma'lumot to'pla
  2. Tahlil qil
  3. Hisobot yoz
  4. Grafiklar yasat
...
orchestrator.assign_tasks({"data_agent":"Ma'lumot to'plash","analyst_agent":"Tahlil qilish","writer_agent":"Hisobot yozish","visual_agent":"Grafiklar yaratish"
})
