    ...
    for item in complex_items:
        if cache.has(item):  # Cache tekshirish
            ...
            <ExpandableCard
              ...
              examples={[
                "Qisqartmalar ishlatish (JSON → J)",
                "Whitespace'larni olib tashlash",
                "Strukturani soddalashtirish",
                "Output format'ni optimallashtirish"
              ]}
            />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <ExpandableCard
                ...
                examples={[
                  ...
                  "Muhim xabarlarni pin qilish",
                  "Vaqt bo'yicha filtrlash",
                  "Prioritet asosida saqlash"
                ]}
              />
              ...
              <ExpandableCard
                ...
                icon={<AiIcon name="compress" size={24} />}
                examples={[
                  "Har 10 xabardan keyin xulosa",
                  "Mavzu bo'yicha guruhlash",
                  "Muhim faktlarni ajratish",
                  "Hierarchik summarization"
                ]}
              />
            </div>
        ...
        return context`}
            ...
            <Card className="border-2 border-gray-600 bg-gray-50">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-white border border-gray-300 rounded">
                    <h5 className="font-bold mb-2">Muammo:</h5>
