          ...
          <Card className="border-2 border-accent/20 bg-gradient-to-r from-gray-50 to-white shadow-medium">
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <motion.div 
                  whileHover={{ scale: 1.02 }}
                  className="text-center p-4 bg-background rounded-none border-2 border-border shadow-soft hover:shadow-medium transition-all"
                >
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-muted p-4 rounded-none border border-border mb-4">
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={idx} className="flex gap-4 items-center">
                      ...
                      <div className="flex-1 bg-muted rounded-none p-4 border border-border">
